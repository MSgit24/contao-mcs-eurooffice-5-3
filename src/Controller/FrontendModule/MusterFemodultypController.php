...
#[AsFrontendModule(category: 'muster_femodulkategorie', template: 'mod_muster_femodultyp')]
class MusterFemodultypController extends AbstractFrontendModuleController
{
    public const TYPE = 'muster_femodultyp';
